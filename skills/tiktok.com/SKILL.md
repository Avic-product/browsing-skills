...
- **get-post-analytics** — Extract visible TikTok Studio analytics for a specific post, including post metadata, overview metric cards, engagement counts, retention notes, traffic sources, search query availability, sidebar posts, and visible chart labels. Full spec: [references/get-post-analytics.md](references/get-post-analytics.md).
